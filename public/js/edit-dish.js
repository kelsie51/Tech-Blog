async function editFormHandler(event) {
  ...
  const blog_name = document.querySelector('#blog_title').value;
  const blog_title = document.querySelector('#blog_content').value;
  ...
  const timestamp = document.querySelector('#timestamp:checked') ? true : false;
